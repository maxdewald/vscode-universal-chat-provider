...
| `universalChatProvider.codex.webSearch`       | Use Codex's native web search, letting the model look things up online and open web pages on its own. Search queries are sent to OpenAI.                                                                                                                                                                                                                        | `boolean` | `false`                   |
| ▿ <b>Advanced</b>                             |
